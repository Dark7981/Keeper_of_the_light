...
public class DarknessSoundScript : MonoBehaviour
{
    ...
    private IEnumerator SoundCheck() // Корутина для запускау нових звуків
    {
        while (true)
        {
            Sounds();
    ...
    private void Sounds() // Метод запуску нових звуків, зміна звучання
    {
    ...
    private IEnumerator SoundEnvironment() //Гуляння звуку від одного вуха до іншого
    {
        while (isPlay)
        {
